...
var MyDatePicker = (function () {
    function MyDatePicker(elem, renderer, cdr, localeService, utilService) {
        ...
        this.dayMouseOver = new _angular_core.EventEmitter();
    ...
    MyDatePicker.prototype.callMouseOver = function (day) {
        this.dayMouseOver.emit(day);
    };
    ...
    MyDatePicker.propDecorators = {
        ...
        'dayMouseOver': [{ type: _angular_core.Output },],
